...
> I used MVVM architecture, because I find it to be easy and it's a Good Practice.
> I implemented the Geolocation Feature to fetch the coordinates of the user
and get display their weather ! I commented the Complex Logic to better understand.
> I implemented the Search Functionality you can enter the city name and see it's weather.
